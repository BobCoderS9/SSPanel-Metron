...
class BobMGate extends AbstractPayment
{
    ...
    {
        $apiUrl = self::pay_config('mgate_api_url');
        $this->appSecret = self::pay_config('mgate_app_secret');
    ...
    {
        return self::get('payment')['mgate'][$key];
    }
    ...
    public function purchase($request, $response, $args)
    {
        ...
        $pl->save();
        $data['app_id'] = self::pay_config('mgate_app_id');
